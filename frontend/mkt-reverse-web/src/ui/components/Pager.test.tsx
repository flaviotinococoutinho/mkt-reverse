...
describe('Pager UX/A11y', () => {
  it('has correct ARIA labels for accessibility', () => {
    ...
    const pagerText = screen.getByText('page').parentElement
    expect(pagerText?.getAttribute('aria-live')).toBe('polite')
    expect(pagerText?.getAttribute('aria-atomic')).toBe('true')
  })
})
